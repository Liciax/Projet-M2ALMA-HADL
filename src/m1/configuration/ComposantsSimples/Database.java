...
public class Database extends ComposantSimple {
	...
	public void ReponseSecurite(String identifiants) {
	...
	public void lancer(String p){
		...
		case "Receive_SecurityManagementPort" : 
			...
			System.out.println("Database : les identifiants de connexion '" +command+ "' sont arriv�s dans le port Receive_SecurityManagementPort, verification de leur validite..." );
