...
public class SecurityManager extends ComposantSimple {
	...
	public void lancer(String p){
		...
		case "Receive_SecurityAnthPort" : 
			...
			LOGGER.info("SecurityManager : les identifiants de connexion '" +command+ "' sont arrives dans le port Receive_SecurityAnthPort, transfert vers la DB pour verifier qu'ils sont valides" );
