...
public class Client extends ComposantSimple {
	...
	public void lancer(String p) {
		LOGGER.info(
		    "Client : signal de la configuration reçu: le port " + p + " viens de recevoir un message qu'il faut traiter");
		String command;
		switch (p) {
		case "EntreeClient":
		...
		case "EntreeClientBinding":
			...
			break;
		default:
			LOGGER.severe("lancer not implemented for this port of the Client");
			break;
		}
	}
}
